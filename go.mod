module github.com/hermeznetwork/hermez-integration

go 1.16

require (
	github.com/Pantani/errors v1.0.1
	github.com/Pantani/logger v1.0.1
	github.com/Pantani/request v1.0.1
	...
	github.com/hermeznetwork/hermez-node v1.0.0
